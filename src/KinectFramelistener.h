...
#ifndef __KinectFrameListener_H__
#define __KinectFrameListener_H__
...
class KinectFrameListener: public FrameListener, public WindowEventListener
{
protected:
...
public:
	...
	KinectFrameListener(RenderWindow* win, Camera* cam, bool bufferedKeys = false, bool bufferedMouse = false,
